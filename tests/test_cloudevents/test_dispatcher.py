...
# Store original providers to restore them later
@pytest.fixture(autouse=True)
def reset_providers():
    # Store original providers
    original_configs = configs_factory.provider
    ...
    configs_factory.override(original_configs)
    event_router_factory.override(original_router)
    event_dispatcher_factory.override(original_dispatcher)
...
def test_dispatched_event(fake_receiver):
    ...
    # property name
    _, _, sent_headers = router.route(event_types.SUBJECT_PROPERTY_CHANGED, subject,
